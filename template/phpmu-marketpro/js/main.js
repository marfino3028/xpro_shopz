(function($) {
    ...
    var isMotore = {
        ...
        Windows: function() {
            return navigator.userAgent.match(/IEMotore/i);
        },
        any: function() {
            return (isMotore.Android() || isMotore.BlackBerry() || isMotore.iOS() || isMotore.Opera() || isMotore.Windows());
        }
    }
    ...
    function subMenuToggle() {
        $('.menu--Motore .menu-item-has-children > .sub-toggle').on('click', function(e) {
            e.preventDefault();
        ...
        $('.menu--Motore .has-mega-menu .mega-menu__column .sub-toggle').on('click', function(e) {
            e.preventDefault();
