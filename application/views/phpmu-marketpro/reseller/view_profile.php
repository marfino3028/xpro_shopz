        ...
        <div class="ps-section__content">
            ...
            <div class="row">
                <div class="col-xl-3 col-lg-3 col-md-12 col-sm-12 col-12 ">
                    <?php
                      echo "<a href='".base_url()."members/edit_profile' class='ps-btn btn-block'><center><i class='icon-pen'></i> Edit Your Profile</center></a>";
                ...
                <div class="col-xl-9 col-lg-9 col-md-12 col-sm-12 col-12 ">
                    <figure class="ps-block--vendor-status biodata">
                        <?php 
                            ...
                            echo "<p style='font-size:17px'>Hi <b>$row[nama_lengkap]</b>, Welcome to Your Profile Page! <br>
                                                            Please Ensure to Fit Your Personal Data With Your Real ID to Make Your Transaction Easier</p><br>
                            ...
                            <div class='form-group row' style='margin-bottom:5px'>
                            <label class='col-sm-2 col-form-label' style='margin-bottom:1px'>Full Name</b></label>
                              <div class='col-sm-10'>
                                $row[nama_lengkap]
                              </div>
                            </div>
                            <div class='form-group row' style='margin-bottom:5px'>
                            <label class='col-sm-2 col-form-label' style='margin-bottom:1px'>Gender</b></label>
                              <div class='col-sm-10'>
                                $row[jenis_kelamin]
                              </div>
                            </div>
                            <div class='form-group row' style='margin-bottom:5px'>
                            <label class='col-sm-2 col-form-label' style='margin-bottom:1px'>Email Address</b></label>
                              <div class='col-sm-10'>
                                $row[email]
                              </div>
                            </div>
                            <div class='form-group row' style='margin-bottom:5px'>
                            <label class='col-sm-2 col-form-label' style='margin-bottom:1px'>Phone Number</b></label>
                            <div class='col-sm-10'>
                              $row[no_hp]
                            </div>
                            </div>
                            ...
                            <div class='form-group row' style='margin-bottom:5px'>
                            <label class='col-sm-2 col-form-label' style='margin-bottom:1px'>Place/Date of Birth</b></label>
                              <div class='col-sm-10'>
                            ...
                            <div class='form-group row' style='margin-bottom:5px'>
                            <label class='col-sm-2 col-form-label' style='margin-bottom:1px'>Address</b></label>
                              <div class='col-sm-10'>
                                ".($row['alamat_lengkap'] == '' ? '<i style="color:#cecece">Must be filled,..</i>' : $row['alamat_lengkap'])."
                              </div>
                            </div>
                            
                            <div class='form-group row' style='margin-bottom:5px'>
                            <label class='col-sm-2 col-form-label' style='margin-bottom:1px'>Location</b></label>
                            <div class='col-sm-10'>
                              ".(kecamatan($row['kecamatan_id'],$row['kota_id']) == '' ? '<i style="color:#cecece">Must be filled,..</i>' : kecamatan($row['kecamatan_id'],$row['kota_id']))."
                            </div>
                            </div>";
                            ...
                            echo "<div class='form-group row' style='margin-bottom:5px'>
                            <label class='col-sm-2 col-form-label' style='margin-bottom:1px'>Registered</b></label>
                            <div class='col-sm-10'>
