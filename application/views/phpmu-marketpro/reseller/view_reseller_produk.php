                ...
                <div class="ps-block--vendor-filter">
                    <div class="ps-block__left">
                        <ul class="ps-tab-list">
                          <li><a href="#"><strong><?php echo $record_hitung->num_rows(); ?></strong> Products Shown : </a></li>

                        </ul>
                    </div>
                    <div class="ps-block__right">
                        <form class="ps-form--search" action="#" method="get">
                            <input class="form-control" type="text" id='search_text' name='search_text' placeholder="Cari produk di toko ini,.">
                        </form>
                    </div>
                </div>
