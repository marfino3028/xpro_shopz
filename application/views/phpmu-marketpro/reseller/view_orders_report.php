                      ...
                      <div class="tab-pane fade show active" id="pending" role="tabpanel" aria-labelledby="pending-tab">
                        <?php 
                          ...
                          <label class='col-sm-2 col-form-label' style='margin-bottom:1px'>Status</b></label>
                            <div class='col-sm-10'>
                              ...
                              if ($row['proses']=='3'){
                                  ...
                                  <a style='padding:10px 25px; line-height:1px; font-weight:300' class='ps-btn' href='".base_url()."members/keranjang_detail/$row[id_penjualan]' onclick=\"return confirm('Track Your package?')\">Belum</a>";
                              }
                            echo "</div>
                          </div>
                          ...
                          <label class='col-sm-2 col-form-label' style='margin-bottom:1px'>Total Belanja</b></label>
                            <div class='col-sm-10'>
                              <span class='text-danger'>Rp ".rupiah($total['total']+$row['ongkir']-$kupon['diskon'])." ($produk Produk)</span>
                            </div>
                          </div><br>";
                            $no++;
                          }
