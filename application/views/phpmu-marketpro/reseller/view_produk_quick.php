...
?><div class="ps-product__meta">
    <p>Weight : <a href="#"><?php echo "$record[berat] Gram" ?></a>,
...
?>
    ...
    <div class='pull-right'>
        ...
        <button type='submit' name='keranjang' class="ps-btn ps-btn--black ml-3" style='color:#fff'>Add to Cart</button>
        <button type='submit' name='beli' class="ps-btn">Buy Now</button>
    </div>
</form>
