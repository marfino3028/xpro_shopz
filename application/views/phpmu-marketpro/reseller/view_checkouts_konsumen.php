              ...
              <?php echo "<form action='".base_url()."produk/selesai_belanja' method='POST'>"; ?>
                ...
                $kon = $this->db->query("SELECT * FROM rb_konsumen where id_konsumen='".$this->session->id_konsumen."'")->row_array();
                  echo "<div class='form-group row' style='margin-bottom:5px'>
                        <label class='col-sm-2 col-form-label' style='margin-bottom:1px; font-weight:bold'>Send To</label>
                        <div class='col-sm-10'>
                            $kon[nama_lengkap]
                        </div>
                        </div>
                        <div class='form-group row' style='margin-bottom:5px'>
                        <label class='col-sm-2 col-form-label' style='margin-bottom:1px; font-weight:bold'>Phone Number</label>
                        <div class='col-sm-10'>
                            ...
                            <label class='col-sm-2 col-form-label' style='margin-bottom:1px; font-weight:bold'>Shipment Address</label>
                            <div class='col-sm-10'>
                                <div class='form-row'>
                                    ...
                                    echo "<option value=''>- Zip/Postal Code -</option>";
                                ...
                                <input type='text' name='alamat' class='form-control form-mini' value='$kon[alamat_lengkap]' placeholder='Street Address, P.O Box, Apt, Suite, Unit, etc' autocomplete='off' required>
                            </div>
                            </div>
                            
                            <div style='padding:5px; font-size:16px; font-weight:bold; background:#f4f4f4; border-bottom:1px solid #ab0534; margin-bottom:10px;'>Your Order Details</div>";
                          $no = 1;
                          ...
                          echo "<a style='font-size:17px; display:block; border-bottom:1px dotted' href='".base_url()."produk/detail/$row[produk_seo]'>$row[nama_produk]</a>
                                <div class='ps-product--cart'>
                                    ...
                                    <p style='margin-bottom:0'>$row[nama_reseller]</p>
                    ...
                    <div class="ps-block--shopping-total">
                        <div class="ps-block__content">
                                  ...
                                  if ($this->session->idp != ''){
                                    ...
                                    foreach ($reseller_order->result_array() as $res) {
                                      ...
                                      echo "<div class='form-group'>
                                            ...
                                            <div class='pelapak'>
                                              <p style='margin-bottom:0px'>Shop : <b>$res[nama_reseller]</b></p>
                                              Seller Address : ".kecamatan($res['kecamatan_id'],$res['kota_id'])."<br>
                                              <input type='hidden' name='toko$noo' value='$res[id_reseller]'>
                                            </div>
                                            </label>
                                            <label style='display:block; cursor:pointer; margin-bottom:0rem'>
                                              <input type='checkbox' name='kurir' class='kurir$noo' value='cod'/> <span style='display:inline-block'>Ship VIA Cash On Delivery</span>
                                            </label>
                                            ...
                                            <select class='form-control form-mini text-success' name='kode_sopir$noo' id='list_sopir$noo' style='margin-bottom:2px'>
                                              <option value='0'>- Ship VIA Local Courier -</option>";
                                          ...
                                          echo "</select>
                                              <select class='form-control form-mini text-success' name='kode_kurir$noo' id='list_kurir$noo' style='margin-bottom: 2px'>
                                                  <option value='0'>-  Others Shipment Method  -</option>";
                            ...
                            <div class="ps-block__header">
                                <p style='margin-bottom:0px'>Weight<span> <?php echo "$total[total_berat] Gram"; ?></span></p>
                                <p style='margin-bottom:0px'>Delivery Fee <span> <input type='text' id='ongkir_view' style='background:none; text-align:right; width:110px' value='0' disabled/></span></p>
                                <?php 
                                ...
                                <div class="form-group--nest" style='margin-top:10px'>
                                    <input class="form-control" name='kode_kupon' id='kode_kupon' type="text" placeholder="Coupon & Voucher Codes">
                            ...
                            <hr><p style='font-size:1.6rem; font-weight:600; margin-bottom:0px'>Select Payment Method :</p>
                            <input type='radio' name='metode' value='transfer' checked> Bank Transfer<br>
                            <input type='radio' name='metode' id='saldo' value='saldo'>  Balance Account (<?php echo "Rp ".rupiah(saldo(reseller($this->session->id_konsumen),$this->session->id_konsumen)); ?>)
                        </div>
                    </div>
                    <button type='submit' name='submit' id='oksimpan' style='display: none' class="ps-btn ps-btn--fullwidth">Process Payment</a>
                </div>
                </div>
                <?php 
