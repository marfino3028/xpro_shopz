<script language="JavaScript" type="text/JavaScript">
  function showSub(){
    <?php
      ...
      foreach ($query->result_array() as $data) {
        ...
        echo "{";
        $query_sub_kategori = $this->db->query("SELECT * FROM rb_kategori_produk_sub where id_kategori_produk='$id_kategori_produk' ORDER BY nama_kategori_sub ASC");
        $content = "document.getElementById('sub_kategori_produk').innerHTML = \"  <option value=''>- Select a Sub Product Category -</option>";
  ...
  function showThirdSub(){
    <?php
      $query_a = $this->db->query("SELECT * FROM rb_kategori_produk_sub");
      foreach ($query_a->result_array() as $data_a) {
        $id_kategori_produk_sub = $data_a['id_kategori_produk_sub'];
        echo "if (document.demo.aa.value == \"".$id_kategori_produk_sub."\")";
        echo "{";
        $query_third_sub_kategori = $this->db->query("SELECT * FROM rb_kategori_produk_sub_third where id_kategori_produk_sub='$id_kategori_produk_sub'  ORDER BY nama_kategori_sub_third ASC");
        $content_a = "document.getElementById('third_sub_kategori_produk').innerHTML = \"  <option value=''>- Select a Third Sub Product Category -</option>";
        foreach ($query_third_sub_kategori->result_array() as $data2_a) {
            $content_a .= "<option value='".$data2_a['id_kategori_produk_sub_third']."'>".$data2_a['nama_kategori_sub_third']."</option>";
        }
        $content_a .= "\"";
        echo $content_a;
        echo "}\n";
...
<?php 
          ...
          echo "<input type='hidden' name='id' value=''>
              <div class='form-group row' style='margin-bottom:5px'>
                <label class='col-sm-2 col-form-label' style='margin-bottom:1px'>Category</b></label>
                  <div class='col-sm-10'>
              ...
              <div class='form-group row' style='margin-bottom:5px'>
                <label class='col-sm-2 col-form-label' style='margin-bottom:1px'>Sub-Category</b></label>
                  <div class='col-sm-10'>
                    <select name='aa' class='form-control form-mini' onchange=\"showThirdSub()\" id='sub_kategori_produk'>
                    <option value='' selected>- Select a Sub Product Category -</option>
                    </select>
                  </div>
              </div>

              <div class='form-group row' style='margin-bottom:5px'>
                <label class='col-sm-2 col-form-label' style='margin-bottom:1px'>Third Sub-Category</b></label>
                  <div class='col-sm-10'>
                    <select name='aaa' class='form-control form-mini' id='third_sub_kategori_produk'>
                    <option value='' selected>- Select a Third Sub Product Category -</option>
                    </select>
                  </div>
              </div>

              <div class='form-group row' style='margin-bottom:5px'>
              <label class='col-sm-2 col-form-label' style='margin-bottom:1px'>Product Title</b></label>
                <div class='col-sm-10'>
              ...
              <div class='form-group row' style='margin-bottom:5px'>
                <label class='col-sm-2 col-form-label' style='margin-bottom:1px'>Minimum Order Quantity</b></label>
                  <div class='col-sm-10'>
              ...
              <div class='form-group row' style='margin-bottom:5px'>
                <label class='col-sm-2 col-form-label' style='margin-bottom:1px'>Product Description</b></label>
                  <div class='col-sm-10'>
              ...
              <div class='form-group row' style='margin-bottom:5px'>
                  <label class='col-sm-2 col-form-label' style='margin-bottom:1px'>Product Details</b></label>
                    <div class='col-sm-10'>
                    <textarea id='editor1' class='form-control' name='ff' style='height:180px'>$rows[keterangan]</textarea>
                    </div>
              </div>
              <div class='form-group row' style='margin-bottom:5px'>
                <label class='col-sm-2 col-form-label' style='margin-bottom:1px'>Product Picture</b></label>
                  <div class='col-sm-10'>
