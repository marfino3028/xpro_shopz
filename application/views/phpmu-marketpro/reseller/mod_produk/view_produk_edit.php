          ...
          echo "<input type='hidden' name='id' value='$rows[id_produk]'>
              ...
              <div class='form-group row' style='margin-bottom:5px'>
                  <label class='col-sm-2 col-form-label' style='margin-bottom:1px'>Third Sub-Category</b></label>
                    <div class='col-sm-10'>
                    <select name='aaa' class='form-control form-mini' id='sub_kategori_produk'>
                      <option value='' selected>- Select a Third Sub Product Category -</option>";
                      $sub_kategori_produk_third = $this->db->query("SELECT * FROM rb_kategori_produk_sub_third");
                      foreach ($sub_kategori_produk_third->result_array() as $row){
                        if ($rows['id_kategori_produk_sub_third']==$row['id_kategori_produk_sub_third']){
                          echo "<option value='$row[id_kategori_produk_sub_third]' selected>$row[nama_kategori_sub_third]</option>";
                        }else{
                          echo "<option value='$row[id_kategori_produk_sub_third]'>$row[nama_kategori_sub_third]</option>";
                        }
                      }
                echo "</select>
                </div>
              ...
              <label class='col-sm-2 col-form-label' style='margin-bottom:1px'></b></label>
                <div class='col-sm-10'>
                  <div class='form-row'>
                    ...
                    <div class='form-group col-md-6' style='margin-bottom:5px'>
                      <label style='margin-bottom:1px'>Discoun (Rp)</label>
              ...
              <div class='form-group row' style='margin-bottom:5px'>
                <label class='col-sm-2 col-form-label' style='margin-bottom:1px'>Minimum Order Quantity
                </b></label>
                  <div class='col-sm-10'>
              ...
              <div class='form-group row' style='margin-bottom:5px'>
                <label class='col-sm-2 col-form-label' style='margin-bottom:1px'>Product Picture</b></label>
                  <div class='col-sm-10'>
                    <img class='preview' loading='lazy' style='width:210px;' src='".base_url()."asset/foto_produk/$rows[gambar]' alt='no-image.jpg' /><br/>
