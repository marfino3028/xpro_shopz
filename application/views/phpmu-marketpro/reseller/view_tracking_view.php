                ...
                <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 ">
                    <div class="ps-block--shopping-total">
                        <div class="ps-block__header">
                            ...
                            ?>
                            <p style='margin-bottom:0px'><b>Order Status<span class='text-danger'><?php echo status($total['proses']); ?></span></b></p><hr>
                            <p style='margin-bottom:0px'>Weight<span> <?php echo "$total[total_berat] Gram"; ?></span></p>
                            <p style='margin-bottom:0px'>Delivery Fee <span> <?php echo "Rp ".rupiah($ong['ongkir']); ?></span></p>
                            <?php 
                                if ($ong['fee_admin']>'0'){
