          ...
          <div class="ps-section__search row">
              <div class="col-md-12">
                <?php 
                  ...
                  echo "<input type='text' name='cari_reseller' class='form-control' placeholder='Find Shop or City...'>
                ...
                foreach ($record->result_array() as $row){
                  ...
                  echo "<div class='col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 '>
                      <article class='ps-block--store-2'>
                          ...
                          <div class='ps-block__author'><a class='ps-block__user' href='#'><img src='".base_url()."asset/foto_user/$foto_user' alt=''></a><a class='ps-btn' href='".base_url()."u/$row[user_reseller]'>Visit</a></div>
                      </article>
                  </div>";
                }
              ?>
