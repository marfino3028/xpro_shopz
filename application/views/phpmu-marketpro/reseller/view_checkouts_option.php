              ...
              <?php echo "<form action='".base_url()."produk/selesai_belanja' method='POST'>"; ?>
                ...
                <?php 
                  echo "<div class='form-group row' style='margin-bottom:5px'>
                        <label class='col-sm-2 col-form-label' style='margin-bottom:1px; font-weight:bold'>Full Name</label>
                        <div class='col-sm-10'>
                            <input type='text' name='nama' class='form-control form-mini' placeholder='- - - - - - - - -' autocomplete='off' required>
                        </div>
                        </div>
                        <div class='form-group row' style='margin-bottom:5px'>
                        <label class='col-sm-2 col-form-label' style='margin-bottom:1px; font-weight:bold'>Contact Number</label>
                        <div class='col-sm-10'>
                            <div class='form-row'>
                                <div class='form-group col-md-6' style='margin-bottom:5px'>
                                    <input type='number' name='telpon' class='form-control form-mini' placeholder='Motore Phone' autocomplete='off' required>
                                </div>
                                <div class='form-group col-md-6' style='margin-bottom:5px'>
                                <input type='email' name='email' class='form-control form-mini' placeholder='Email Address' autocomplete='off' required>
                                </div>
                            </div>
                        </div>
                        </div>
                        ...
                        <label class='col-sm-2 col-form-label' style='margin-bottom:1px; font-weight:bold'>Shipping Address</label>
                        <div class='col-sm-10'>
                            <div class='form-row'>
                            ...
                            <input type='text' name='alamat' class='form-control form-mini' placeholder='Street Address, P.O Box, Apt, Suite, Unit, etc' autocomplete='off' required>
                        </div>
                        </div>
                            ...
                            echo "<a style='font-size:17px; display:block; border-bottom:1px dotted' href='".base_url()."produk/detail/$row[produk_seo]'>$row[nama_produk]</a>
                                  <div class='ps-product--cart'>
                                      ...
                                      <div class='ps-product__content' style='text-align:left; padding-left:0px'>
                                          ...
                                          $variasi = $this->db->query("SELECT * FROM rb_produk_variasi where id_produk='$row[id_produk]' ORDER BY id_variasi DESC");
                                          if ($variasi->num_rows()>0){
                                              ...
                                              foreach ($variasi->result_array() as $va) {
                                                  ...
                                                  $variasix = explode(";",$va['variasi']);
                                                  for ($i=0; $i < count($variasix) ; $i++) { 
                                                      $nama_variasi = "variasi".$noo.$i.$no;
                                                      $_ck = (array_search($nama_variasi, $variasi_terpilih) === false)? '' : 'checked';
                                                      if ($_ck=='checked'){
                                                        echo "<span style='color:blue'>".$variasix[$i]."</span> &nbsp; ";
                                                      }
                                                  }
                                                  echo "</div>";
                                                  $noo++;
