<ul class="ps-section__links d-none d-sm-block">
    <?php 
        ...
        // $data = array('<i class="icon-user"></i> Profile','<i class="icon-couch"></i> Sosmed','<i class="icon-bag-dollar"></i> Data Bank','<i class="icon-bag-dollar"></i> Keuangan','<i class="icon-heart"></i> Wishlist','<i class="icon-bag2"></i> Pembelian','<i class="icon-phone"></i> PPOB','<i class="icon-car"></i> Jadi Kurir '.$pesanan_sopir.'');
        // $link = array('profile','sosial_media','rekening_bank','withdraw','wishlist','orders_report','trx_pulsa','sopir');
        $data = array('<i class="icon-user"></i> Profile','<i class="icon-bag-dollar"></i> Bank Account','<i class="icon-heart"></i> Wishlist','<i class="icon-bag2"></i> Purchase History');
