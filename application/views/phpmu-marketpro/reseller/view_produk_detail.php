...
$harga_dollar = $record['harga_dollar'] <= 0 ? "" : "HK$ $record[harga_dollar]";
                ...
                <div class="ps-product__header">
                    ...
                    <div class="ps-product__info">
                        ...
                        <div class="ps-product__meta">
                            <p>Weight : <a href="#"><?php echo "$record[berat] Gram" ?></a></p>
                            <?php echo "<p>Stock <b>".($beli['beli']-$jual['jual'])."</b> $record[satuan]</p>"; ?>
                            ...
                            <div class="ps-product__rating">
                                ...
                                <span>(<?php echo rate_jumlah($record['id_produk']); ?> Customer Feedback)</span>
                            </div>
                        </div>
                        <h4 class="ps-product__price">
                        <?php echo "$harga_konsumen <del style='color:#8a8a8a'>$harga_asli</del>"; ?>
                        <?php echo "<br><small><i>$harga_dollar</i></small>"; ?>
                        <?php 
                            if ($record['minimum']>1){
                        ...
                        <div class="ps-product__desc">
                            <p><?php echo verifikasi_icon($record['id_reseller'])."<br>"; ?>
                            <a href="<?php echo base_url()."u/".user_reseller($record['id_reseller']).""; ?>"><strong> <?php echo cek_paket_icon($rows['id_reseller']).' '.$rows['nama_reseller']; ?></strong></a>
                            <?php 
                            ...
                            <?php 
                                ...
                                if ($variasi->num_rows()>0){ echo "<p>";
                                    foreach ($variasi->result_array() as $va) {
                                        ...
                                        // echo '<div style="padding:3px 0px">'+split_data(data[i].nama,data[i].variasi,(i+1))+' </div>';
                                    }
                                    echo "</p>";
                                }
                        ...
                        <div class="ps-product__shopping d-none d-sm-block">
                            ...
                            <?php 
                                if (stok($record['id_reseller'],$record['id_produk'])<=0){ 
                                    echo "<a style='color:#a7a7a7; background-color:#e2e2e2' class='ps-btn ps-btn--black ml-3 add-to-cart-empty'>Add to Cart</a>";
                                }else{
                                    echo "<a style='color:#fff' id='$record[id_produk]' class='ps-btn ps-btn--black ml-3 add-to-cart'>Add to Cart</a>";
                                }
                            ?>
                            <!-- <button type='submit' name='keranjang' class="ps-btn ps-btn--black ml-3" href="#">Add to Cart</button> -->
                            <button type='submit' name='beli' class="ps-btn" href="#">Buy Now</button>
                            <a style='color:#fff' id='$record[id_produk]' class='ps-btn ps-btn--danger ml-3'>Message</a>
                        </div>
                        <?php $idn = $this->db->query("SELECT * FROM identitas where id_identitas='1'")->row_array(); ?>
                        <div class="ps-product__specification">
                            <!--<a class="report" target='_BLANK' href="<?php echo "https://api.whatsapp.com/send?phone=".format_telpon($idn['no_telp'])."&amp;text=Hallo%20kak!,%20Saya%20Mau%20Melaporkan%20Produk%20ini%20:%20$record[nama_produk]..."; ?>">Laporkan Penyalahgunaan</a>-->
            ...
            <?php $komentar = $this->db->query("SELECT * FROM tbl_comment where id_produk='$record[id_produk]'")->num_rows(); ?>
                <div class="ps-product__content ps-tab-root">
                    <ul class="ps-tab-list">
                        ...
                        <li><a href="#tab-3">Seller</a></li>
                        <li><a href="#tab-4">Feedback (<?php echo rate_jumlah($record['id_produk']); ?>)</a></li>
                        <li><a href="#tab-5">Discussion (<?php echo $komentar; ?>)</a></li>
                    </ul>
                    <div class="ps-tabs">
                ...
                <div class="widget__content">
                    <?php
                        foreach ($hasil->result_array() as $row) {	
                            ...
                            if ($diskon>=1){ 
                                $harga_produk =  "Rp ".rupiah($row['harga_konsumen']-$disk['diskon'])." <del>".rupiah($row['harga_konsumen'])."</del>";	                                $harga_produk =  "Rp ".rupiah($row['harga_konsumen']-$disk['diskon'])." <del>".rupiah($row['harga_konsumen'])."</del>";
