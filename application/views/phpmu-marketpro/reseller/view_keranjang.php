...
<div class="ps-breadcrumb">
    <div class="container">
        <ul class="breadcrumb">
            ...
            <li><a href="<?php echo base_url()."produk"; ?>">Product</a></li>
                ...
                <?php 
                  if ($this->session->idp == ''){
                    ...
                    echo "<div class='col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12 '>
                      <form action='".base_url()."produk/keranjang' method='POST'>
                        ...
                        <div class='ps-section__cart-actions'>
                            <a class='ps-btn' href='".base_url()."produk'><i class='icon-arrow-left'></i> Back to Shopping</a>
                            <button type='submit' name='update' style='padding:10px 25px' class='ps-btn'>Proceed to Checkout <i class='icon-arrow-right'></i></button>
                        </div>
                    </form>";
                    ?>
                    </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 ">
                        <p style='margin-bottom:0px' align='center'> <b>ORDER SUMMARY</b></p>
                        <div class="ps-block--shopping-total">
                        <div class='keranjang-page'>
                            <div class="ps-block__header">
                                <p style='margin-bottom:0px'><b>ORDER STATUS UPDATE<span> <?php echo $proses; ?></span></b></p><hr>
                                ...
                                <?php 
                                  ...
                                  if ($fv[0]>'0'){
                                    $fee_admin = $fv[0];
                                    echo "<p style='margin-bottom:0px'>Admin Fee <span>Rp ".rupiah($fv[0])."</span></p>";
                                  }else{
                                    $fee_admin = 0;
                                  }
                                ?>
                                ...
                                <ul class="ps-block__product">
                                    ...
                                    if ($this->session->idp != ''){
                                      ...
                                      foreach ($penjual->result_array() as $pen) {
                                        ...
                                        echo "<li><b>$pen[nama_reseller]</b> (Seller) <br>
                                                  Shipping From : <i style='color:green'>".kecamatan($pen['kecamatan_id'],$pen['kota_id'])."</i></li>";
                                      }
                                    }
                                    ?>
