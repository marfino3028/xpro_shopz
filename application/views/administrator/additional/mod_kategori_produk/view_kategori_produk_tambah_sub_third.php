    ...
    echo "<div class='col-md-12'>
              <div class='box box-info'>
                <div class='box-header with-border'>
                  <h3 class='box-title'>Tambah Sub Third Kategori Produk</h3>
                </div>
              <div class='box-body'>";
              $attributes = array('class'=>'form-horizontal','role'=>'form');
              echo form_open_multipart('administrator/tambah_kategori_produk_sub_third',$attributes); 
          echo "<div class='col-md-12'>
                  ...
                  <tbody>
                    ...
                    echo "</td></tr>
                    <tr><th width='140px' scope='row'>Nama Sub Third Kategori</th>    <td><input type='text' class='form-control' name='a' required></td></tr>
