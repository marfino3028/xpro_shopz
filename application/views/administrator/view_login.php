  ...
  <body class="hold-transition login-page">
    <div class="login-box">
      ...
      <div class="login-box-body">
        ...
        <hr>
        <a class='link' data-dismiss="modal" aria-hidden="true" data-toggle='modal' href='#lupapass' data-target='#lupapass'>Forget Password?</a>
                  ...
                  ?>
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-3">
                            ...
                            &nbsp; &nbsp; &nbsp;<a data-dismiss="modal" aria-hidden="true" data-toggle='modal' href='#login' data-target='#login' title="Forget Password">Back to Sign In?</a>
                        </div>
                    </div>
