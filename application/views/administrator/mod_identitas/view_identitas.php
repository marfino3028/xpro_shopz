                ...
                <div class='col-md-6 col-xs-12'>
                  <div class='form-group'>
                    ...
                    <div class='col-sm-9'>
                      ...
                      <small><i>Nama Tampil - untuk Admin Resolution Center</i></small>
                    </div>
                  </div>
                  ...
                  <div class='form-group'>
                    ...
                    <small><i>Jumlah Produk yang dapat diposting oleh Pelapak (Free Seller)</i></small>
                    </div>
                  </div>
                  ...
                  <div class='form-group'>
                    ...
                    echo "<br><small><i>Izinkan Konsumen Menghubungi Pelapak via Whatsapp?</i></small>
                    </div>
                  </div>
                  ...
                  <div class='form-group'>
                    ...
                    echo "<br><small><i>Langsung Aktifkan URL Referral Saat Pendaftaran Konsumen?</i></small>
                    </div>
                  </div>
            ...
            echo form_open_multipart($this->uri->segment(1).'/identitaswebsite',$attributes); 
              ...
              <div class='col-md-6 col-xs-12'> 
                  <div class='form-group'>
                    ...
                    echo "<br><small><i>Verifikasi Pengaktifan Akun Toko/Pelapak oleh admin.</i></small>
                    </div>
                  </div>
                  ...
                  <div class='form-group'>
                    ...
                    echo "<br><small><i>Untuk Order Produk harus Login atau tanpa Login?</i></small>
                    </div>
                  </div>
                  ...
                  <div class='form-group'>
                    ...
                    <small><i>Fee admin tiap transaksi sukses (Dibebankan ke Konsumen).</i></small>
                    </div>
                  </div>
                  ...
                  <div class='form-group'>
                    ...
                    <small><i>Fee diambil dari transaksi sukses pelapak yang disponsori.</i></small>
                    </div>
                  </div>
                  ...
                  <div class='form-group'>
                    ...
                    <small><i>Fee untuk Tiap Transaksi Withdraw / Penarikan Dana.</i></small>
                    </div>
                  </div>
                  ...
                  <div class='form-group'>
                    ...
                    <small><i>Nilai Minimal Tiap Transaksi Withdraw / Penarikan Dana.</i></small>
                    </div>
                  </div>
              ...
              <div class='col-md-6 col-xs-12'>
                ...
                <div class='form-group'>
                    ...
                    <small><i>Fee Transaksi Ipaymu dibayarkan oleh Konsumen.</i></small>
                    </div>
                  </div>
              ...
              echo form_open_multipart($this->uri->segment(1).'/identitaswebsite',$attributes); 
                echo "<input type='hidden' name='id' value='$record[id_identitas]'>
                  <div class='col-md-6 col-xs-12'>
                  <div class='form-group'>
                    <label class='col-sm-3 control-label'>Domain Wablas</label>
                    <div class='col-sm-9'>
                    <input type='text' class='form-control' style='color:green' name='wa_domain' placeholder='API WA Gateway https://console.wablas.com' value='".config('wa_domain')."'>
                    </div>
                  </div>
                  
                  <div class='form-group'>
                    <label class='col-sm-3 control-label'>API Wablas</label>
                    <div class='col-sm-9'>
                    <input type='text' class='form-control' style='color:green' name='wa' placeholder='Token API WA Gateway https://wablas.com/' value='".$maps[2]."'>
                    </div>
                  </div>
                  ...
                  <div class='form-group'>
                    ...
                    <div class='col-sm-9'>
                      <input type='text' class='form-control' style='color:green' name='maps' placeholder='API dari https://tripay.co.id' value='".$maps[0]."'>
                  ...
                  <div class='form-group'>
                    ...
                    <div class='col-sm-9'>
                      <input type='text' class='form-control' style='color:green' name='api_rajaongkir' placeholder='API https://rajaongkir.com PRO' value='$record[api_rajaongkir]'>
                    </div>
                  </div>
                  ...
                  <div class='form-group'>
                    ...
                    <div class='col-sm-9'>
                      <input type='text' class='form-control' style='color:green' name='api_resi' placeholder='API Cek Resi Dari https://binderbyte.com/' value='".config('api_resi')."'>
                        <small><i>Api Cek Resi Alternatif untuk : <span style='color:red'>".config('api_resi_off')."</span></i></small>
                    </div>
                  </div>
                  ...
                  <div class='form-group'>
                    ...
                    if (config('api_resi_aktif')=='rajaongkir'){
                      echo "<input type='radio' name='api_resi_aktif' value='rajaongkir' checked> Rajaongkir <i style='color:orange'>(Binderbyte Alternatif)</i> &nbsp; 
                            <input type='radio' name='api_resi_aktif' value='binderbyte'> Binderbyte (Only)";
                    }else{
                      echo "<input type='radio' name='api_resi_aktif' value='rajaongkir'> Rajaongkir <i style='color:orange'>(Binderbyte Alternatif)</i> &nbsp; 
                  ...
                  <div class='form-group'>
                    ...
                    <div class='col-sm-9'>
                    <input type='text' class='form-control' style='color:green' placeholder='API http://mutasibank.co.id' value='$record[api_mutasibank]' name='api_mutasibank'>
                    </div>
                  </div>
                ...
                <div class='col-md-6 col-xs-12'>
                  ...
                  <div class='form-group'>
                    ...
                    <div class='col-sm-9'>
                    <input type='text' class='form-control' placeholder='Nama Pengirim Email (Ex : SHOP.XPROGROUP.COM.AU)' name='pengirim_email' value='$record[pengirim_email]'>
                    </div>
                  </div>
