		...
		if (isset($_POST['submit3'])){
			...
			if ($total > 0){
				...
				$message      = "<html><body>Halooo! <b>".$data['nama_lengkap']."</b> ... <br> 
					...
					Jika Anda mencurigai seseorang mungkin memiliki akses tidak sah ke akun Anda, kami sarankan Anda mengubah Password sebagai tindakan pencegahan dengan mengunjungi $iden[url].</body></html> \n";
