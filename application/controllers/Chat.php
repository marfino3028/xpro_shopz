		...
		if (isset($_POST['submit'])){
			...
			if ($cek_orderan->num_rows()>=1){
				...
				if ($cek_exist->num_rows()>=1){
					...
					$isi_pesan_pembeli = "*$iden[pengirim_email]* - Hallo *$ter[nama_reseller]*, orderan dari toko anda dengan No Invoice #$ter[kode_transaksi] Telah dilaporkan bermasalah, 
...
anda diundang untuk diskusi terkait masalah ini disini : ".base_url()."komplain/room/$id_pusat_bantuan";
					...
					$subject_notif      = "$iden[pengirim_email] - Komplain Order #$ter[kode_transaksi] untuk Toko Anda";
					$message_notif = "<html><body><b>$iden[pengirim_email]</b> - Hallo <b>$ter[nama_reseller]</b>, orderan dari toko anda dengan No Invoice #$ter[kode_transaksi] Telah dilaporkan bermasalah,<br><br> 
